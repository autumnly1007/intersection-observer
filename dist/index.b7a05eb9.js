...
const inputEl = document.querySelector("input"); // 타입 단언
...
const io = new IntersectionObserver((entries)=>{
    entries.forEach((entry)=>{
        ...
        if (entry.isIntersecting) searchMovies(inputEl.value, currentPage + 1);
    });
});
...
async function searchMovies(title, page = 1) {
    ...
    if (page === 1) movieListEl.innerHTML = "";
    showLoader();
    currentPage = page;
...
},{}]},["84Rv8","jeorp"], "jeorp", "parcelRequirebff0")
